...
public class frmNhapKhoReport extends JPanel {
	...
	public frmNhapKhoReport(DatabaseManager dbManager) {
	...
	private void createFormPanel() {
		...
		JLabel lblFMapn = new JLabel("Mã phiếu nhập:");
		...
		String[] columnNames = { "Mã phiếu nhập", "Mã sản phẩm", "Tên sản phẩm", "Đơn giá", "Đơn vị tính", "Số lượng",
				"Thành tiền", "Mã nhân viên", "Ngày nhập", "Mã kho", "Tổng tiền" };
		...
		JLabel lblBoCoChi = new JLabel("BÁO CÁO CHI TIẾT NHẬP KHO");
